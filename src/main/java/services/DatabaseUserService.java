...
class DatabaseUserService implements UserService {
     ...
     * @throws services.UserServiceException       if there is a problem creating the person record.
     * @throws services.DuplicateUserNameException if the user name is not unique.
     */
    @Override
